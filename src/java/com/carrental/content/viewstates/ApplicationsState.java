...
/**
 * Configures the composite page for viewing applications:
 * - all applications - for administrator
 * - personal applications - for any registered user
 * 
...
public class ApplicationsState extends State {
     ...
     * @param manager 
     */
    public ApplicationsState(ContentManager manager) {
        super(manager);
    }
    ...
    public void init(HttpServletRequest request) {
        ...
        s.setAttribute( PARAM_MENU_CONTENT, PageConfigManager.getPagePath( "pagepath.menu.applications" ) );  
