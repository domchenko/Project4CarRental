...
/**
 * Configures the composite page for viewing search order form
 * 
 * @author Tanya Domchenko
 * @version 1, 22 Jan 2016
 */
public class SearchOrderState extends State {

    /**
     * Default constructor
     * @param manager 
     */
    public SearchOrderState(ContentManager manager) {
        super(manager);
    }
    ...
    public void init(HttpServletRequest request) {
        ...
        s.setAttribute( PARAM_MENU_CONTENT, PageConfigManager.getPagePath( "pagepath.menu.searchorder" ) ); 
